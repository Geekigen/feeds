...
<div class="flex justify-center">
    <form method="post" action="/feed" class="bg-white p-6 rounded-lg w-1/3" @submit.prevent="submitForm">
      @csrf
      <div class="mb-4">
        @if ($errors->any())
...
<option value="synthetic amino">synthetic amino</option>
      ...
      <div class="mb-4">
        <div class="border border-gray-400 p-2 w-full">
          ...
          <input type="text" id="me" name="me" class="border border-gray-400 p-2 w-full">
        </div>
      </div>
      ...
      <div class="mb-4">
        <div class="border border-gray-400 p-2 w-full">
          ...
          <input type="text" id="cp" name="cp" class="border border-gray-400 p-2 w-full">
        </div>
      </div>
        ...
        <div class="mb-4">
          ...
          <div class="mb-4">
            <div class="border border-gray-400 p-2 w-full">
              ...
              <input type="text" id="ca" name="ca" class="border border-gray-400 p-2 w-full">
            </div>
          </div>
          <div class="mb-4">
            <div class="border border-gray-400 p-2 w-full">
              <label for="p" class="block text-gray-700 font-medium mb-2">P:</label>
              <input type="text" id="p" name="p" class="border border-gray-400 p-2 w-full">
            </div>
            <div class="mb-4">
              <div class="border border-gray-400 p-2 w-full">
                <label for="cost" class="block text-gray-700 font-medium mb-2">Cost:</label>
                <input type="text" id="cost" name="cost" class="border border-gray-400 p-2 w-full">
              </div>
          </div>
